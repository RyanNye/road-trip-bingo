...
CRITICAL RULE: Every item must be something a passenger can see from inside a car traveling on the highway WITHOUT exiting. Nothing more than 1 mile from the road. If you can only see it by pulling off and walking, it does not qualify.
...
Guidelines:
- VISIBILITY FIRST: Every item must be visible from inside a moving car on the highway, within 1 mile of the road
